...
public class NewShippingActivityRequest extends StringRequest {
    private static final String url = "https://bsor3a.com/clients/neworders";
    private Map<String, String> params;

    public NewShippingActivityRequest(String ClientID, Response.Listener<String> listener) {
